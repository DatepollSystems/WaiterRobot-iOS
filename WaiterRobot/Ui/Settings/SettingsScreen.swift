...
struct SettingsScreen: View {
    ...
    @StateObject private var viewModel = ObservableViewModel(viewModel: koin.settingsVM())
            ...
            List {
                Section {
                    ...
                    SettingsItem(
                        ...
                        action: viewModel.actual.refreshAll
                    )
                    ...
                    SettingsItem(
                        ...
                        action: viewModel.actual.switchEvent
                    )
                }

                Section {
                    SwitchThemeView(initial: viewModel.state.currentAppTheme, onChange: viewModel.actual.switchTheme)
                }
