...
struct OrderScreen: View {
    ...
    @StateObject private var viewModel: ObservableViewModel<OrderState, OrderEffect, OrderViewModel>

    private let table: shared.Table

    init(table: shared.Table, initialItemId: KotlinLong?) {
        self.table = table
        _viewModel = StateObject(wrappedValue: ObservableViewModel(viewModel: koin.orderVM(table: table, initialItemId: initialItemId)))
